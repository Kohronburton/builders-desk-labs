...
-- Runtime never owns/applies migrations.
REVOKE INSERT, UPDATE, DELETE ON app.schema_migrations FROM PLACEHOLDER_RUNTIME_DB_ROLE;

-- Intentionally no USAGE or object privileges on proprietary data.
...
REVOKE ALL ON ALL SEQUENCES IN SCHEMA internal FROM PLACEHOLDER_RUNTIME_DB_ROLE;
